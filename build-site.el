;; Initial configuration taken from Daniel Linden's config https://github.com/djliden/djliden.github.io/
;;; packages
...
;; (unordered ("[[file:index.org][(2021-12-01) Petr Mukhachev's Home Page]]") ("[[file:about.org][(2021-11-28) About Me]]") ("posts" (unordered ("[[file:posts/test1.org][(2021-11-28) Resources]]") ("[[file:posts/test2.org][(2021-11-28) Another Post]]"))))
...
(setq org-publish-project-alist
      (list
       (list "org-site:main"
             ...
             :time-stamp-file nil
             :auto-sitemap t
             :sitemap-title nil;"Petr Mukhachev's Blog"
...
;;                  :title "Petr Mukhachev's Blog"
;;                  :description "Data, AI, and other writing from Petr Mukhachev"
